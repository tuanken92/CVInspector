...
public:
	...
	int GetValueInt(LPCTSTR valueName, int iDefault = 0);
	double GetValueDouble(LPCTSTR valueName, double dDefault = 0.0);
	BOOL GetValueBool(LPCTSTR valueName, BOOL bDefault=FALSE);
